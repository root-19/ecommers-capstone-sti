...
function sendOTP($email) {
    ...
    try {
        ...
        $mail->Port       = 587;                                    
        // Recipients
        $mail->setFrom('hperformanceexhaust@gmail.com', 'HP');
      ...
      <div class="form-row">
         <div class="form-column">
           ...
           <input type="email" name="email" required placeholder="Enter your email" maxlength="50" class="box">
            ...
            <input type="text" name="address" required placeholder="Confirm Full Address"  class="box">
        ...
        <!-- Add more cities as needed -->
            ...
            <input type="text" name="pin_point" required placeholder="Plus Code in G-Maps"  class="box">
